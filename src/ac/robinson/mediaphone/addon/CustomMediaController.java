...
/*
 *  @Haiyue Yuan 2014
 *  Modified to create more options on the media controller
 */

package ac.robinson.mediaphone.addon;
...
/**
 * Add new button for print option
 * 
 */
...
public class CustomMediaController extends FrameLayout {
	...
	private View.OnClickListener mNextListener, mPrevListener, mEditListener;
	...
	protected View makeControllerView() {
		...
		mRoot = inflate.inflate(R.layout.custom_video_controller, null);
	...
	private void initControllerView(View v) {
		...
		// @Haiyue edit button
		/*
		 * mEditButton = (ImageButton) v.findViewById(R.id.editplayback); if(mEditButton != null){
		...
		// @Haiyue edit button
		mPrintButton = (ImageButton) v.findViewById(R.id.print);
		if (mPrintButton != null && !mFromXml && !mListenersSet) {
	...
	public void setEnabled(boolean enabled) {
		...
		if (mPrintButton != null) {
			mPrintButton.setEnabled(enabled && mEditListener != null);
		}
		disableUnsupportedButtons();
	...
	private void installPrevNextListeners() {
		...
		if (mPrintButton != null) {
			mPrintButton.setOnClickListener(mEditListener);
			mPrintButton.setEnabled(mEditListener != null);
		}
	...
	public void setPrevNextListeners(View.OnClickListener next, View.OnClickListener prev,
			View.OnClickListener editplayback) {
		mNextListener = next;
		mPrevListener = prev;
		mEditListener = editplayback;
		mListenersSet = true;
